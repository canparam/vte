				...
				return e = t, (n = [{
					...
					value: function(t) {
						...
						if (n && n.items && n.items.length) {
							...
							"file" === o.kind && -1 !== o.type.indexOf("image/index.html") ? (this.context.invoke("editor.insertImagesOrCallback", [o.getAsFile()]), t.preventDefault()) : "string" === o.kind && this.context.invoke("editor.isLimited", n.getData("Text").length) && t.preventDefault()
					...
					return e = t, (n = [{
						...
						value: function() {
							if (this.lastWordRange) {
								...
								if (e && (e[1] || e[2])) {
									var n = e[1] ? t : "http://" + t,
										o = this.options.showDomainOnlyForAutolink ? t.replace(/^(?:https?:\/\/)?(?:tel?:?)?(?:mailto?:?)?(?:www\.)?/i, "").split("https://dev.techneinfosys.com/")[0] : t,
			...
			var se = function() {
				...
				return e = t, (n = [{
					...
					value: function(t) {
						...
						return this.options.shortcuts && e ? (m.isMac && (e = e.replace("CMD", "âŒ˜").replace("SHIFT", "â‡§")), " (" + (e = e.replace("BACKSLASH", "\\").replace("SLASH", "https://dev.techneinfosys.com/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]")) + ")") : ""
					}
				}, {
					key: "button",
					value: function(t) {
