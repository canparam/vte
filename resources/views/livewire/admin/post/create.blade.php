                    ...
                    <div class="card border">
                        ...
                        <div class="card-body px-0">
                            <div class="form-group">
                                ...
                                <input type="text" wire:model.defer="seo.title" autocomplete="off" class="form-control" id="metaTitle"
                                       aria-describedby="emailHelp" placeholder="Meta Title">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="metaDes">Meta Description</label>
                                <textarea class="form-control" wire:model.defer="seo.description" autocomplete="off" id="metaDes" rows="3" placeholder="Meta Description"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
